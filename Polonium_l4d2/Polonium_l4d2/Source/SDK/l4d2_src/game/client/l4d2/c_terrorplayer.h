...
inline C_TerrorPlayer* ToTerrorPlayer(IClientEntity* pClientEntity)
{
	if (!pClientEntity)
		return nullptr;

#ifdef _DEBUG
	return dynamic_cast<C_TerrorPlayer*>(pClientEntity);
#else
	return static_cast<C_TerrorPlayer*>(pClientEntity);
#endif
}